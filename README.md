...
Timeline:
* 01/16: [62% reads]((extdata/fastqscreen/cytokine.rnaseq.readsdistribution.uniquehit.csv)) have unique human transcriptome hits and [15.8% reads](cytokine.rnaseq.readsdistribution.multiplehit.csv) have multiple hit in human genome. 
